...
import { FRANSK_WORDSORT_P1 } from './fransk_part1';
import { FRANSK_WORDSORT_P2 } from './fransk_part2';
import { FRANSK_WORDSORT_P3 } from './fransk_part3';
import { FRANSK_WORDSORT_P4 } from './fransk_part4';
...
export const FRANSK_WORDSORT: Partial<Record<Grade, GameContent[]>> = mergeGameContent(
  FRANSK_WORDSORT_P1,
  FRANSK_WORDSORT_P2,
  FRANSK_WORDSORT_P3,
  FRANSK_WORDSORT_P4
